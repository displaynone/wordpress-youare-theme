  ...
  if (is_page()) {
    ...
    if (!$ms[1]) {
      if ((int) $page_object->post_parent > 0) {
        ...
        <h1 class="title"><a href="<?php echo $parent_page_slug; ?>" title="<?php _e('Go to', 'youare'); ?> <?php echo $parent_post_name; ?>"><?php echo $parent_post_name; ?></a></h1>
        <ul class="subnav">
        ...
        ?>
        <h1 class="title"><?php echo $page_object->post_title; ?></h1>
        <?php
      }
    } else {
        ?>
      <h1 class="title"><a href="/<?php echo $page_object->post_name; ?>" title="<?php _e('Go to', 'youare'); ?> <?php echo $page_object->post_title; ?>"><?php echo $page_object->post_title; ?></a></h1>
      <ul class="subnav">
  ...
  <div class="container">
    <div class="row content-background bottom_corner">
      ...
      <div id="content"> 
        ...
        <div class="twelvecol singlepost"> 
          <?php
          while (have_posts()) {
            the_post();
